...
class NewsFeedList {
  ...
  static NewsFeedList fromJson(json) => NewsFeedList(
      type: json['type'],
      title: json['title'],
...
List<NewsFeedList> getNews() {
  const newsFeed = [
    ...
    {
      "className": "Class teacher iV-A",
      "title": " congratulations Mam!!  Keep going so proud of her !!",
      "type": "2ndText",
    ...
    },
    {
      ...
      "title": "Thank you for sharing this wonderful pic , ma'am ",
      "type": "homeWork",
      "visibility": "Visible to Class Teacher",
      "teacher": "Ashwin ",
      "subtitle":
          "A click of the school from entrance which shows the new board of the school and every",
      "imagelink":
  ...
  return newsFeed.map<NewsFeedList>(NewsFeedList.fromJson).toList();
}
